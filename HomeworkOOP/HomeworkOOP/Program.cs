...
class Program
{
    static void Main()
    {
        ...
        FootballPlayer[] team1Players = new FootballPlayer[]
        {
            ...
            new Midfielder("Player 6", 26, 6, 175, team1),
            new Midfielder("Player 7", 27, 7, 180, team1),
            new Midfielder("Player 8", 25, 8, 182, team1),
            new Striker("Player 9", 30, 9, 185, team1),
            new Striker("Player 10", 29, 10, 178, team1),
            new Striker("Player 11", 20, 11, 184, team1)
        };

        FootballPlayer[] team2Players = new FootballPlayer[]
        {
            ...
            new Midfielder("Player 17", 26, 6, 175, team2),
            new Midfielder("Player 18", 25, 7, 187, team2),
            new Midfielder("Player 19", 28, 8, 182, team2),
